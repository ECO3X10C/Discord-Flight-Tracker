    ...
    try:
        ...
        for flight in fr_api.get_flights(callsign.upper()):
            ...
            if flight.check_info(callsign=plane.upper()):    
                ...
                embed.add_field(name="Altitude", value=(f"{flight.altitude}ft"), inline=True)
                embed.add_field(name="Heading", value=(f"{flight.heading}°"), inline=True)
                embed.add_field(name="Ground Speed", value=(f"{flight.ground_speed}kts"), inline=True)
